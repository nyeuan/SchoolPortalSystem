<?php
// File: admin/admin-manage-course.php
$required_role = 'Admin';
...
<body class="bg-gradient-to-br from-school-green via-[#125730] to-school-yellow min-h-screen font-serif text-gray-800 flex flex-col md:flex-row">
            ...
            <div class="flex flex-col sm:flex-row justify-between sm:items-center gap-4">
                ...
                <div class="flex flex-wrap items-center gap-2">
                    <?php if ($selected_grade_id > 0 || !empty($search)): ?>
                        <a href="admin-manage-course.php" class="bg-gray-100 text-gray-700 px-4 py-2.5 rounded-2xl font-semibold hover:bg-gray-200 transition text-xs font-sans">← Reset View</a>
                    <?php endif; ?>
                        ...
                        <?php foreach ($courses as $course): ?>
                            <div class="bg-[#fcfbf7] rounded-2xl p-5 shadow-md border border-school-gold/10 flex flex-col justify-between font-sans relative">
                                ...
                                <div class="mt-6 flex justify-between items-center border-t pt-4 border-gray-100 gap-2">
                                    <a href="admin-course-assignment.php?id=<?= $course['Course_ID'] ?>" class="text-center bg-blue-50 text-blue-600 border border-blue-200 px-3 py-2 rounded-xl hover:bg-blue-100 transition text-xs font-semibold flex-1">Assign Users</a>
    ...
    <!-- Modals point to admin-add-course.php locally -->
