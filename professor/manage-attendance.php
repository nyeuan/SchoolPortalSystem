...
try {
    ...
    // 2. Fetch Grade level and Section metadata (From updated version)
    ...
    // 3. Roster of actively enrolled students (Client-side JS handles pagination safely)
    $roster_sql = "
    ...
    // 4. Existing attendance records for the selected date, keyed by student
    ...
    // 5. Quick history snapshot - tallies per student across the whole course
    ...
    // 6. Distinct dates that have any attendance logged, for quick navigation
...
<body class="bg-gradient-to-br from-school-green via-[#125730] to-school-yellow min-h-screen font-serif text-gray-800 flex flex-col md:flex-row">
            ...
            <?php else: ?>
                ...
                <form action="save-attendance.php" method="POST">
                    ...
                    <div class="p-6 flex flex-col md:flex-row justify-between items-center gap-4 border-t border-gray-100 font-sans">
                        <button type="submit"
                            class="bg-school-green text-white px-6 py-3 rounded-2xl font-semibold hover:bg-school-green-hover transition w-full md:w-auto order-last md:order-first shadow-md">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (!rosterBody) return; // Escape if roster is empty
