<?php
// File: professor/prof-homepage.php
                    ...
                    <?php else: ?>
                        <div class="space-y-4 font-sans">
                            ...
                            <?php if ($hasAdminDropdown): ?>
                                <div class="text-center pt-2"><button id="adminToggleBtn" onclick="toggleAdminLogs()" class="text-xs text-school-green font-bold bg-school-green/5 border border-school-green/10 hover:bg-school-green/10 transition px-4 py-2 rounded-xl inline-flex items-center gap-1">Show More Logs ▾</button></div>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
                </section>
            ...
            <div class="space-y-6">
                <section class="bg-[#fcfbf7] rounded-2xl p-6 shadow-lg border border-school-gold/20">
                    ...
                    <div class="grid grid-cols-1 gap-2.5 font-sans">
                        ...
                        <a href="../shared/Account-info.php" class="p-3 bg-gray-50 rounded-xl hover:bg-school-green/5 border border-gray-200 transition flex justify-between items-center text-sm font-medium"><span>Update Profile Settings</span><span class="text-school-green">→</span></a>
                    </div>
                </section>
            </div>
        </div>
