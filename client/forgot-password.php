...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($email) || empty($contact_num) || empty($new_password)) {
        ...
        try {
            // Validation step: ensure the identity exists using dual-column verification matches
            ...
            if (!$user_id) {
                ...
                // Securely hash the recovery password before modifying the database table
